"""
This is code more suitable for testing hyperparameters
...
x_train, x_test, y_train, y_test = data.get_data(split=0.3,random_state=seed)

acc = []
pred_y = collections.defaultdict(int)

node_counts = [i for i in range(8, 1024, 16)]
